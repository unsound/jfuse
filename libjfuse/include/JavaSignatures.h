...
#define OPS_SETXATTR_BSD_SIGNATURE  "(" JAVA_CLASS(BYTEBUFFER_CLASS) JAVA_CLASS(BYTEBUFFER_CLASS) JAVA_CLASS(BYTEBUFFER_CLASS) "IJ)I"
...
#define OPS_GETXATTR_BSD_SIGNATURE  "(" JAVA_CLASS(BYTEBUFFER_CLASS) JAVA_CLASS(BYTEBUFFER_CLASS) JAVA_CLASS(BYTEBUFFER_CLASS) "J)I"
...
#define OPS_SETCHGTIME_NAME         "setchgtime"
#define OPS_SETCHGTIME_SIGNATURE    "(" JAVA_CLASS(BYTEBUFFER_CLASS) JAVA_CLASS(TIMESPEC_CLASS) ")I"
