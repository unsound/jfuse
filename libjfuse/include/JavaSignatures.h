...
#define OPS_SETXATTR_SIGNATURE      "(" JAVA_CLASS(BYTEBUFFER_CLASS) JAVA_CLASS(BYTEBUFFER_CLASS) JAVA_CLASS(BYTEBUFFER_CLASS) "IJ)I"
#define OPS_GETXATTR_NAME           "getxattr"
#define OPS_GETXATTR_SIGNATURE      "(" JAVA_CLASS(BYTEBUFFER_CLASS) JAVA_CLASS(BYTEBUFFER_CLASS) JAVA_CLASS(BYTEBUFFER_CLASS) "J)I"
